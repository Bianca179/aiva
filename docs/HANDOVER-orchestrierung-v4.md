...
- **Nebenbefund:** 5 alte „Freigegeben" vom 27.07. (Christiane, Doris Graf, Vanessa Schönmetz, Silke Niehaus, Anna Lagosch) = die warmen Spur-2-Kontakte; seit Wochen unversendet trotz täglicher 10:00-Läufe (vermutlich „Notiz gesendet" gesetzt oder bereits Juli-Runde). Nicht angefasst; falls Bianca sie sauber aus der Kalt-Pipeline will → auf „Übersprungen" setzen (Zuruf genügt).
