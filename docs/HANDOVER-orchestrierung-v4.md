...
- **Offen:** Biancas eigener Funktionstest im Chat (erste echte Konversation); Cartoon-Avatar aus Biancas Foto als Bot-Gesicht (Bianca liefert Foto → Comic-Version erstellen → Widget-Avatar via platform_settings.widget/custom_avatar_path); Feinschliff Begrüßung/Farben im Widget (Dashboard).
