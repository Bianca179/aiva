...
- **Offen:** Zielgruppen-Hypothese Produkt 3 (Speaking Coach App) von Bianca bestätigen/schärfen (Stellschrauben: „Suchauftraege" + „Qualifizieren (Sam)"); Spur 2 (Warm/E-Mail) wartet weiter auf Stimme-Skill (Bianca/Petra); Marketing-Übergabe der 5 Produkte als Vorschlag im Chat (Produkte-Tabelle als Single Source → Redaktionsplan → Linni), wartet auf Biancas Go.
