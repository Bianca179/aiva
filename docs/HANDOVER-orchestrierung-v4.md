...
- **Vorschlag an Bianca (wartet auf Go):** (1) **Lexware-Artikel-Tool** für Sophia + Donna (Webhook nach sophia-produkt-Muster, NUR lesen: Artikel + Preise live). (2) **Angebots-Entwurf-Automation:** nach C-Gespräch legt n8n aus Artikeln + Lead-Kontakt ein Angebot als ENTWURF in Lexware an; **Versand macht Bianca in Lexware** (Empfehlung: Angebote sind verbindlich — Agenten sollen Entwürfe anlegen, nicht versenden; Biancas „im Zweifel versenden" wäre alternativ als Cockpit-Button mit ihrem Klick abbildbar).\n
